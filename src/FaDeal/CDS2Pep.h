...
void More_HelpFM11()
{
	cout<<"\n\
\n\
\t\t1.  CDS2Pep -i <inCDS.fa > -o AAA -w\n\
\t\tthis will get the Pep data from the input CDS file, output Pep to a compressed file named AAA in current directory and list the ID of CDS sequence with problem if any. The problematic CDS sequences refer to those neither have correct initiation/stop codons, nor have a length of the multiples of 3.\n\
\n\
\n";
}
...
{
	if (argc <=1 ) {print_AusageA09();return 0;}
