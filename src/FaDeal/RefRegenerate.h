...
int  usage_FA05()
{
	cout <<""
		"\n"
		"\tUsage: JoinSca -i  <in.sca> -o <out.fa> \n"
		"\n"
		"\t\t-i     <str>    input scaffolds fa\n"
		"\t\t-o     <str>    output FASTA with pseudo chromosome\n"
		"\n"
		"\t\t-c     <str>    scaffolds starting with this pattern in names would not join to pseudo chromosomes, default [Chr]\n"
		"\t\t-n     <str>    names for the pseudo chromosome, default [NewChr]\n"
		"\t\t-b     <int>    number of N inserted between two joined scaffolds, default [150]\n"
		"\t\t-s     <int>    number of pseudo chromosomes in final output, default [20]\n"
		"\t\t-l     <int>    length of each new pseudo chromosome\n"
		"\t\t-g              unzipped output\n"
		"\n"
