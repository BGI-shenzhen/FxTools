...
int  usage_FA03()
{
	cout <<""
		...
		"\t\t-o     <str>   output file\n"
		"\n"
		"\t\t-l     <int>   the minimum of length for sequence to pass filter, default [1000]\n"
		"\t\t-n   <float>   the ratio of miss N. Sequences with missing N more than this value would be filtered, default [0.5]\n"
		"\n"
...
\n\
\t\t2.  filter -i <in.fa> -o AAA -l X -n Y\n\
