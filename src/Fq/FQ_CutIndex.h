...
int  print_usage_B01()
{
	cout <<""
		...
		"\t\t-i    <str>   input FASTQ\n"
		"\n"
		"\t\t-o    <str>   output FASTQ, default [STDOUT]\n"
		"\t\t-s    <int>   the start site to cut, default [5]\n"
		"\t\t-e            the end site to cut, default [Rleng (length of read)]\n"
		"\n"
...
{
	if (argc <=1  ) {print_usage_B01();return 0;}
