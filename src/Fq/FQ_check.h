...
int  print_usage_FqCheck()
{
	cout <<""
		"\n"
		"Usage:fqcheck  -i <1.fq>  <2.fq> -o <1.fqcheck> <2.fqcheck> [options]\n"
		"\n"
		"\t\t-i     <str>   input PE FASTQ. For SE FASTQ, just omit <2.fq>\n"
		"\t\t-o     <str>   output for PE FASTQ. For SE FASTQ, just omit <out.2>\n"
		"\n"
		"\t\t-a     <str>   input PE adapters fa file,For SE FASTQ, just omit <2.fa>\n"
		"\n"
		"\t\t-h             show more details for help [v2.05]\n"
		"\n";
	return 1;
}
...
void More_HelpFQ()
{
	cout<<"\n\
\n\
\t\t1.  fqcheck -i <1.fq> <2.fq> -o AAA BBB\n\
...
{
	if (argc <=1  ) {print_usage_FqCheck();return 0;}
