...
int  print_Ausage_A30()
{
	cout <<""
		...
		"\n"
		"\t\t-i    <str>   input FASTQ\n"
		"\t\t-l    <str>   list of FASTQ to get statistics \n"
		"\n"
		"\t\t-o    <str>   output statistics, default [STDOUT]\n"
		"\t\t-p    <int>   number of thread, default [1]\n" 
		"\n"
...
\t\tthis is the same as example 2, but instead of typing all the names with option -i, user could add the names of the FASTQ in a list and use the -l option. In this case, the file.list would look like:\n\
\t\tfq1\n\
\t\tfq2\n\
\t\tfq3\n\
\n\
...
{
	if (argc <=1 ) {print_Ausage_A30();return 0 ;}
	int file_count=0;
