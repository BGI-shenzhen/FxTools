...
int  print_AusageFA04()
{
	cout <<""
		"\n"
		"\tUsage: getCdsPep -i <in.fa> -g <in.gff>  -o <out> \n"
		"\n"
		"\t\t-i       <str>   input FASTA\n"
		"\t\t-g       <str>   input GFF\n"
		"\t\t-o       <str>   output cds/pep sequences\n"
		"\n"
...
cout<<"\n\
\n\
\t\t1.  getCdsPep -i <in.fa> -g file.gff -o AAA \n\
\t\tthis will find the CDS and Pep sequences based on the GFF file and output these two in current directory. \n\
\n";
}

int parse_AcmdFA04(int argc, char **argv , In3str1v * paraFA04 )
{
	if (argc <=1) {print_AusageFA04();return 0;}
