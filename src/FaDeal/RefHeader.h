...
void More_HelpFA_D1 ()
{
	cout<<"\n\
\t\t1.	dict -i <in.fa>\n\
\t\tthis will give the header (ID and length of each sequence) as standard output\n\
\n\
\t\t2.	dict -i <in.fa> -o AAA\n\
\t\tthis will give the header (ID and length of each sequence) in a file named AAA in current directory.\n\
\n\
\n";
}
...
{
	if (argc <=1 ) {print_Headerusage();return 0;}
